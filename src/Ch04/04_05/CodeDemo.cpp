...
int main(){
    ...
    // George ((5 * 3) + (4 * 4) + (3 * 2)) / (5 + 4 + 3)
    
    // float points, float credits
    // Treverse through grades. 
        // find id = grd.student_id
        // float num_grd;
        // find (switch) and assign num_grd;
        // Treverse through courses and find a match for course id
        // when a match found, increment the points and credits values 
    // GPA = points / credits
